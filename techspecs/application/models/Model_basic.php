...
class Model_basic extends CI_Model
{
	...
	{
		$info = $this->getSingle('ts_category',"slug='".$slug."'");	
		return  $info['id'];
	}
	...
	{
		$info = $this->getSingle('ts_attribute','id='.$id);		
		return  $info;
	}

	public function getProductImage($id)
	{
		$imageInfo = $this->getSingle('ts_product_image','product_id='.$id." AND is_featured = 'Yes' ");
