          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                <tr>
                  <td><?php echo $this->Model_basic->getAttributeName($list['parent_id']); ?></td>
                  <td><?php echo stripslashes($list['attribute_name']); ?></td>
                  <td><?php echo stripslashes($list['attribute_value']); ?></td>
                  <td><?php echo stripslashes($list['attribute_details']); ?></td>                
                  <td>
