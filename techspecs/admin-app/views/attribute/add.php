            ...
            <form class="form-horizontal" method="post" action="">
              ...
              <div class="box-body">                
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" name="parent_attribute" id="parent_attribute" >
                      ...
                      ?>
                        <option value="<?php echo $attribute['id'];?>" > <?php echo $attribute['attribute_name'];?></option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" id="inputEmail3" value="<?php echo set_value('attribute_name');?>" name="attribute_name" placeholder="Attribute Name" type="text">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label hor-form">Attribute Value</label>
                  <div class="col-sm-8">
                    <input class="form-control" id="inputEmail3" value="<?php echo set_value('attribute_value');?>" name="attribute_value" placeholder="Attribute Value" type="text">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" id="inputEmail3" value="<?php echo set_value('attribute_details');?>" name="attribute_details" placeholder="Attribute Details" type="text">
                  </div>
                </div>
