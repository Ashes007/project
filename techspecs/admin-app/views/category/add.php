            ...
            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" id="inputEmail3" value="<?php echo set_value('category_name');?>" name="category_name" placeholder="Category Name" type="text" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" id="inputEmail3" name="image_name[]" type="file" required>
                  </div>
                </div>
