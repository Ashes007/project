...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>TechSpecs</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
   

    <form action="<?php echo BACKEND_URL."login/do_login";?>" method="post">
    ...
    <a href="<?php echo BACKEND_URL."login/forgotpassword";?>">I forgot my password</a><br>
