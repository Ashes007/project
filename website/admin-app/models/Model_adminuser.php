...

{
	...
	public function getSingle($email, $password)
	{
...

		{
			...
			$this->session->set_userdata('ADMIN_ID', $rec['id']);

			$this->session->set_userdata('ADMIN_EMAIL', $rec['email']);

			$this->session->set_userdata('ADMIN_NAME', $rec['name']);
...

	{
		...
		$sql = "SELECT * FROM ".$this->adminUser." WHERE email = '".$email."'";
	...
	public function get_single($id){
		...
		$sql = "SELECT * FROM ".$this->adminUser." WHERE admin_id = '" . $id . "'";
	...
	public function deleteAdminUser($id){
		...
		$sql = "DELETE FROM ".$this->adminUser." WHERE admin_id = '".$id."'";
	...
	public function deleteBatchAdminUsers(){
		...
		if(!$error){
			...
			if($apply_action == 'Delete'){
				...
				$sql = "DELETE FROM ".$this->adminUser." WHERE FIND_IN_SET(admin_id, '".implode(",", $pagearray)."')";
